    ...
    <main data-theme="dark" className="relative grid min-h-screen place-items-center overflow-hidden bg-black px-5 py-10 text-white">
      ...
      <section className="clicko-login-enter relative w-full max-w-[390px]">
        <div className="mb-9 flex justify-center">
          <a href="/" aria-label="Ir para o Dashboard" title="Ir para o Dashboard" className="rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#111111] p-7">
          <div className="mb-7 text-center">
            <h1 className="text-[20px] font-semibold tracking-[-0.02em]">Acesse o Clicko AI Studios</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button disabled={submitting} className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-white text-[10px] font-semibold text-[#0B0B0B] transition-transform hover:scale-[1.01] disabled:opacity-70">
              {submitting ? <><ClickoLoader className="h-5 w-10" />Entrando...</> : <>Entrar no Studio<ArrowRight className="h-4 w-4" /></>}
            </button>
          </form>
        ...
        <p className="mt-5 text-center text-[8px] uppercase tracking-[0.24em] text-[#3A3A3A]">Clicko AI Studios · criação em movimento</p>
      </section>
    </main>
  );
};
